...
def compile_user_input():
    ...
    while successful_first_list == 0 and user_input != 'quit': #intervals start out empty and stay empty if we don't get valid input
        ...
        if user_input == 'quit':
            ...
            try:
                ...
                try:
                    ...
                    try:
                        if intervals: #only try to merge intervals if you made the intervals
